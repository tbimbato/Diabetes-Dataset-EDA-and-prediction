...
\fancyhead[R]{\small University of Verona --- A.Y. 2024/2025}
\fancyfoot[C]{\thepage}
...
\begin{titlepage}
    ...
    \vspace{1.5cm}
    {\large\itshape Programming and Database --- Data Science\par}
    \vspace{0.5cm}
    {\normalsize University of Verona (UNIVR)\par}
    {\normalsize Academic Year 2024/2025\par}
    \vspace{0.5cm}
    {\normalsize Professor: Niccolò Marastoni\par}
    \vspace{2cm}
...
diabetes dataset. The project was developed as part of the
\textit{Programming and Database} course of the Data Science Master's programme
at the University of Verona (A.Y.\ 2024/2025).
...
\caption{Physiological thresholds used for outlier removal.
         ...
         educational purposes only; not medically validated.}}
\label{tab:outlier}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{llll}
\toprule
...
\vspace{1em}
\noindent\textit{Disclaimer: this project is purely educational and was
developed for the Programming and Database course at the University of Verona.
Results must not be used for medical diagnosis or treatment.}
