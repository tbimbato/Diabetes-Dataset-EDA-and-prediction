...
This document provides an overview of a complete data science workflow for diabetes detection, including data cleaning, EDA, model benchmarking, and interactive deployment.

The project compares four classifiers (Logistic Regression, Decision Tree, K-Nearest Neighbors, Random Forest) on a real-world dataset of 1,009 patient records, reaching best held-out accuracy above 98\% (up to 99.5\%).


This work demonstrates technical methodology only and should not be considered a medical diagnostic system. Results must not be used for professional diagnosis or treatment.
...
\begin{itemize}
    \item \texttt{datasets/}: Contains raw and processed datasets.
