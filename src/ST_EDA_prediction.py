...
with col3:
    ...
    fig, ax = plt.subplots(figsize=(4,4))
    sns.kdeplot(dataset['AGE'], fill=True, ax=ax)
    ax.set_xlabel("Age")
...
fig, ax = plt.subplots(figsize=(12, 8))
sns.kdeplot(dataset[selected_feature], fill=True, ax=ax)
...
fig, ax = plt.subplots(figsize=(12, 8))
sns.heatmap(dataset.corr(numeric_only=True), annot=True, fmt=".2f", cmap="coolwarm", cbar_kws={'shrink': 0.8}, linewidths=0.5, ax=ax)
